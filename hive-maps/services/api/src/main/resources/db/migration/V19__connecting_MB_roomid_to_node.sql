...
UPDATE room SET nodeID = 'MB1.ENTRANCE_1' WHERE id = 'MB-1-ELEVATOR-1';
UPDATE room SET nodeID = 'MB1.ENTRANCE_2' WHERE id = 'MB-1-ELEVATOR-2';
...
UPDATE room SET nodeID = 'MBS2.ENTRANCE' WHERE id = 'MB-S2-ELEVATOR-2'; -- avoid duplicate MBS2.ELEVATOR
